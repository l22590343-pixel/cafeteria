...
try {
    PreparedStatement ps = con.prepareStatement(
        ...
        "ORDER BY b.activa DESC, b.fecha_fin ASC"
    );
...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  .dias-badge{padding:4px 12px;border-radius:20px;font-size:.78rem;font-weight:700;text-align:center;min-width:70px;}
  ...
  .empty{color:#b8a88a;font-size:.9rem;padding:8px 0;}
</style>
</head>
<body>
<div class="topbar">
...
<div class="container">
  ...
  <% if (activas.isEmpty()) { %>
  <p class="empty">No hay becas activas.</p>
  <% } else { for (Object[] b : activas) {
      int diasRestantes = (int) b[7];
      int diasTomados = (int) b[5];
  ...
  <div class="beca-row <%= porVencer ? "por-vencer" : "" %>">
    <div class="beca-info">
      ...
      <div class="fechas">📅 <%= b[3] %> al <%= b[4] %> &nbsp;·&nbsp; 🍽️ <%= diasTomados %> días tomados</div>
    </div>
  ...
  <% if (vencidas.isEmpty()) { %>
  <p class="empty">No hay becas vencidas.</p>
